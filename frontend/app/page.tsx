...
import { 
  ...
  Activity, ShieldCheck, ShieldAlert, HelpCircle, FileCheck, Award, Pill, Volume2
} from "lucide-react";
        ...
        <div className="w-full bg-[#eef3f8] border border-blue-100/80 rounded-3xl p-6 sm:p-8 mb-10 shadow-xs">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl sm:text-2xl font-extrabold text-[#0f2942] tracking-tight">
              Access Samanvaya Healthcare Services
            </h2>
            <Link
              href="/his"
              className="px-4 py-2 bg-white hover:bg-slate-50 text-[#0f4c81] text-xs font-bold rounded-xl border border-blue-200 shadow-2xs transition-all flex items-center gap-1.5 cursor-pointer"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            {/* Card 5: Smart Parchi Patient Kiosk */}
            <Link 
            ...
            >
              <div>
                ...
                <p className="text-xs text-gray-500 font-medium leading-relaxed">
                  Real-time token display board, doctor wait-time forecasting & SMS queue pass.
                </p>
              </div>
              <div className="mt-6 flex items-center justify-between">
                <div className="w-8 h-8 rounded-full border border-gray-300 group-hover:border-[#0f4c81] flex items-center justify-center text-gray-400 group-hover:text-[#0f4c81] transition-all">
            ...
            {/* Card 7: Clinical Decision Support & RAG */}
            <Link 
              href="/his/rag"
              className="group bg-white rounded-2xl p-6 border border-gray-200 hover:border-[#0f4c81] shadow-xs hover:shadow-md transition-all flex flex-col justify-between min-h-[190px] cursor-pointer"
            >
            ...
            {/* Card 8: Phase 2 Civic Suite - AMR Audit & Tele-MANAS */}
            <Link 
            ...
            >
              <div>
                ...
                <p className="text-xs text-gray-500 font-medium leading-relaxed">
                  WHO AWaRe antibiotic stewardship audit & confidential 24x7 Mental Health Helpline (14416).
                </p>
              </div>
              <div className="mt-6 flex items-center justify-between">
                <div className="w-8 h-8 rounded-full border border-gray-300 group-hover:border-[#0f4c81] flex items-center justify-center text-gray-400 group-hover:text-[#0f4c81] transition-all">
